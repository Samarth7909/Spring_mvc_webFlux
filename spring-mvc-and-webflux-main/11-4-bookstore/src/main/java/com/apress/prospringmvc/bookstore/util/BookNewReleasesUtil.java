...
public class BookNewReleasesUtil {
	...
	public static final List<Book> NEW_BOOKS = List.of(
			new Book("Spring Boot 3 Recipes", BigDecimal.valueOf(38.44), 2022, "", "9781484227899",
					Book.Category.SPRING),
			new Book("Spring WebFlux for Dummies", BigDecimal.valueOf(39.44), 2021, "Isamarth", "9781484227888",
					Book.Category.SPRING),
			new Book("Reactive Java Recipes", BigDecimal.valueOf(49.44), 2022, "Isamarth", "97814842278944",
					Book.Category.JAVA),
			new Book("JavaScript for the Backend Developer", BigDecimal.valueOf(51.44), 2025, "James Crook",
					"9781484227822", Book.Category.WEB),
			new Book("Pro Spring 6", BigDecimal.valueOf(59.44), 2022, "Isamarth", "9781484227893",
					Book.Category.SPRING),
			new Book("Reactive Spring", BigDecimal.valueOf(25.44), 2025, "Josh Long", "9781484227111",
					Book.Category.SPRING),
			new Book("Spring MVC and WebFlux", BigDecimal.valueOf(50.44), 2025, " & Isamarth",
					"9781484227222", Book.Category.WEB));
