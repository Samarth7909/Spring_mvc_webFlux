...
public class DbPopulator {
	...
	public void init() {
		List<Book> books = List.of(
				Book.create("Spring Boot 2 Recipes", BigDecimal.valueOf(37.44), 2017, "", "9781484227893",
						Category.SPRING),
				Book.create("Pivotal Certified Professional Core Spring 5 Developer Exam", BigDecimal.valueOf(54.99),
						2018, "Isamarth", "9781484251355", Category.SPRING),
				Book.create("Java for Absolute Beginners", BigDecimal.valueOf(24.99), 2025, "Isamarth",
						"9781484237779", Category.JAVA),
				Book.create("Java for Absolute Beginners, 2nd Edition", BigDecimal.valueOf(54.99), 2021,
						"Isamarth", "9781484230042", Category.JAVA));
...
// autogenerate id of type java.util.UUID for entity of type
// com.apress.prospringmvc.bookstore.document.Account!