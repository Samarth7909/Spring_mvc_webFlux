...
public class DataInitializer {
	...
	public void init() {
		...
		bookRepo.saveAll(Flux.just(
				new Book("Spring Boot 2 Recipes", "", "9781484227893", Category.SPRING),
				new Book("Pivotal Certified Professional Core Spring 5 Developer Exam", "Isamarth",
						"9781484251355", Category.SPRING),
				new Book("Java for Absolute Beginners", "Isamarth", "9781484237779", Category.JAVA))).subscribe(
