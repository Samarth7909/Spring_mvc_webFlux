...
public class PresentationHandler {
	...
	public Mono<ServerResponse> newsFragment(ServerRequest request) {
		final IReactiveSSEDataDriverContextVariable dataDriver = new ReactiveDataDriverContextVariable(
				presentationService.techNews(),
				1, "techNews");
	...
	public Mono<ServerResponse> releasesFragment(ServerRequest request) {
		final IReactiveSSEDataDriverContextVariable dataDriver = new ReactiveDataDriverContextVariable(
				presentationService.newReleases(),
				1, "newBooks");
