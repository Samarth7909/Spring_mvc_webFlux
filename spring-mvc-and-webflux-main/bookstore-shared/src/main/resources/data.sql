...
INSERT INTO book (title, isbn, author, description, year, price, category_id) VALUES ('Spring Boot 2 Recipes', '9781484227893','', '', 2017, 37.44, 1);
INSERT INTO book (title, isbn,  author, description, year, price, category_id) VALUES ('Pivotal Certified Professional Core Spring 5 Developer Exam', '9781484251355', 'Isamarth', '', 2025, 54.99, 1);
INSERT INTO book (title, isbn,  author, description, year, price, category_id) VALUES ('Java for Absolute Beginners', '9781484237779', 'Isamarth','', 2018, 24.99, 2);
