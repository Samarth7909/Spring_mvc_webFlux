...
public class DbConfiguration {
	...
	public Properties hibernateProperties() {
		...
		hibernateProp.put("hibernate.use_sql_comments", false); // set this on 'true' if you want to see the generated
																// sql
		hibernateProp.put("hibernate.show_sql", false); // set this on 'true' if you want to see the generated sql in a
														// readable manner
	...
	// needed because Hibernate does not drop the database and delete this file as
	// it should
	@PostConstruct
